                ...
                <article class="card">
                    <figure class="card-figure">
                        <a href="<?= get_permalink($post_pequeno[0]) ?>" class="d-block position-relative ">
                            <img width="270" height="214" src="<?= get_the_post_thumbnail_url($post_pequeno[0]) ?>" class="card-img img-fluid wp-post-image" alt="<?= get_the_title($post_pequeno[0]) ?>" decoding="async">         <svg class="card-figure-ico position-absolute" width="118" height="118" viewBox="0 0 118 118">
                                <use xlink:href="#svg-video"></use>
                            </svg>
                        </a>
                    </figure>
